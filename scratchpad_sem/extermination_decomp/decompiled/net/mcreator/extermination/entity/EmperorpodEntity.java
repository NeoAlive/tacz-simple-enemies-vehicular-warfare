...
import net.mcreator.extermination.entity.EmperorpodEntity.1;
import net.mcreator.extermination.init.ExterminationModEntities;
import net.mcreator.extermination.procedures.EmperorpodDeathTimeIsReachedProcedure;
import net.mcreator.extermination.procedures.EmperorpodEntityDiesProcedure;
import net.mcreator.extermination.procedures.EmperorpodEntityIsHurtProcedure;
import net.mcreator.extermination.procedures.EmperorpodOnEntityTickUpdateProcedure;
import net.mcreator.extermination.procedures.EmperorpodThisEntityKillsAnotherOneProcedure;
...
public class EmperorpodEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(EmperorpodEntity.class, EntityDataSerializers.f_135035_);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(EmperorpodEntity.class, EntityDataSerializers.f_135030_);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(EmperorpodEntity.class, EntityDataSerializers.f_135030_);
   ...
   public EmperorpodEntity(SpawnEntity packet, Level world) {
      this((EntityType<EmperorpodEntity>)ExterminationModEntities.EMPERORPOD.get(), world);
   }

   public EmperorpodEntity(EntityType<EmperorpodEntity> type, Level world) {
      super(type, world);
      this.f_21364_ = 200;
      this.m_21557_(false);
      this.m_21530_();
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "emperorpod");
   }
   ...
   protected void m_8099_() {
      super.m_8099_();
      this.f_21345_.m_25352_(1, new 1(this, this, 1.0, false));
      ...
      this.f_21345_.m_25352_(19, new AvoidEntityGoal(this, Creeper.class, 10.0F, 1.0, 1.0));
   }
   ...
   public boolean m_6469_(DamageSource source, float amount) {
      EmperorpodEntityIsHurtProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   ...
   public void m_6667_(DamageSource source) {
      ...
      EmperorpodEntityDiesProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), source.m_7639_());
   }
   ...
   public void m_5993_(Entity entity, int score, DamageSource damageSource) {
      ...
      EmperorpodThisEntityKillsAnotherOneProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }

   public void m_6075_() {
      super.m_6075_();
      EmperorpodOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, 450.0);
      builder = builder.m_22268_(Attributes.f_22284_, 25.0);
      builder = builder.m_22268_(Attributes.f_22281_, 60.0);
      builder = builder.m_22268_(Attributes.f_22277_, 60.0);
      builder = builder.m_22268_(Attributes.f_22278_, 40.0);
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (this.animationprocedure.equals("empty")) {
         if (event.isMoving() || !(event.getLimbSwingAmount() > -0.15F) || !(event.getLimbSwingAmount() < 0.15F)) {
            return event.setAndContinue(RawAnimation.begin().thenLoop("animation.emperorpod.walk"));
         } else {
            return this.m_21224_()
               ? event.setAndContinue(RawAnimation.begin().thenPlay("animation.emperorpod.death"))
               : event.setAndContinue(RawAnimation.begin().thenLoop("animation.emperorpod.idle"));
         }
      } else {
   ...
   protected void m_6153_() {
      ...
      if (this.f_20919_ == 100) {
         ...
         this.m_21226_();
         EmperorpodDeathTimeIsReachedProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
      }
   }
