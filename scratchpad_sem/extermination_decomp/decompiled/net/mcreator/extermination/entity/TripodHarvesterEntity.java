...
import net.mcreator.extermination.entity.TripodHarvesterEntity.1;
import net.mcreator.extermination.init.ExterminationModEntities;
import net.mcreator.extermination.procedures.TripodHarvesterDeathTimeIsReachedProcedure;
import net.mcreator.extermination.procedures.TripodHarvesterEntityDiesProcedure;
import net.mcreator.extermination.procedures.TripodHarvesterOnEntityTickUpdateProcedure;
...
public class TripodHarvesterEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(TripodHarvesterEntity.class, EntityDataSerializers.f_135035_);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(TripodHarvesterEntity.class, EntityDataSerializers.f_135030_);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(TripodHarvesterEntity.class, EntityDataSerializers.f_135030_);
   ...
   public TripodHarvesterEntity(SpawnEntity packet, Level world) {
      this((EntityType<TripodHarvesterEntity>)ExterminationModEntities.TRIPOD_HARVESTER.get(), world);
   }

   public TripodHarvesterEntity(EntityType<TripodHarvesterEntity> type, Level world) {
      super(type, world);
      this.f_21364_ = 30;
      this.m_21557_(false);
      this.m_21530_();
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "tripod_harvester");
   }
   ...
   public void m_6667_(DamageSource source) {
      ...
      TripodHarvesterEntityDiesProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      TripodHarvesterOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (this.animationprocedure.equals("empty")) {
         if (event.isMoving() || !(event.getLimbSwingAmount() > -0.15F) || !(event.getLimbSwingAmount() < 0.15F)) {
            return event.setAndContinue(RawAnimation.begin().thenLoop("animation.tripod_harvester.walk"));
         } else {
            return this.m_21224_()
               ? event.setAndContinue(RawAnimation.begin().thenPlay("animation.tripod_harvester.death"))
               : event.setAndContinue(RawAnimation.begin().thenLoop("animation.tripod_harvester.idle"));
         }
      } else {
   ...
   protected void m_6153_() {
      ...
      if (this.f_20919_ == 100) {
         ...
         this.m_21226_();
         TripodHarvesterDeathTimeIsReachedProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      }
   }
