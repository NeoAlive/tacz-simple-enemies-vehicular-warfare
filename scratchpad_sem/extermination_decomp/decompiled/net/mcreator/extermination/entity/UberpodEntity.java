...
import net.mcreator.extermination.procedures.UberpodDeathTimeIsReachedProcedure;
import net.mcreator.extermination.procedures.UberpodEntityDiesProcedure;
import net.mcreator.extermination.procedures.UberpodEntityIsHurtProcedure;
import net.mcreator.extermination.procedures.UberpodOnEntityTickUpdateProcedure;
...
public class UberpodEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(UberpodEntity.class, EntityDataSerializers.f_135035_);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(UberpodEntity.class, EntityDataSerializers.f_135030_);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(UberpodEntity.class, EntityDataSerializers.f_135030_);
   ...
   public UberpodEntity(SpawnEntity packet, Level world) {
      this((EntityType<UberpodEntity>)ExterminationModEntities.UBERPOD.get(), world);
   }

   public UberpodEntity(EntityType<UberpodEntity> type, Level world) {
      super(type, world);
      this.f_21364_ = 80;
      this.m_21557_(false);
      this.m_21530_();
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "uberpod");
   }
   ...
   public boolean m_6469_(DamageSource source, float amount) {
      UberpodEntityIsHurtProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   ...
   public void m_6667_(DamageSource source) {
      ...
      UberpodEntityDiesProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), source.m_7639_());
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      UberpodOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, 280.0);
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (this.animationprocedure.equals("empty")) {
         if (event.isMoving() || !(event.getLimbSwingAmount() > -0.15F) || !(event.getLimbSwingAmount() < 0.15F)) {
            return event.setAndContinue(RawAnimation.begin().thenLoop("animation.uberpod.walk"));
         } else {
            return this.m_21224_()
               ? event.setAndContinue(RawAnimation.begin().thenPlay("animation.uberpod.death"))
               : event.setAndContinue(RawAnimation.begin().thenLoop("animation.uberpod.idle"));
         }
      } else {
   ...
   protected void m_6153_() {
      ...
      if (this.f_20919_ == 100) {
         ...
         this.m_21226_();
         UberpodDeathTimeIsReachedProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      }
   }
