...
/**
 * Session-only invasion progress row: {@code [⌂][N]…[N][⌂]} at top-centre.
 * Entrance uses frame-rate-independent exponential smoothing into fixed slot X.
 */
...
public final class InvasionHudOverlay {
    ...
    /** Room above the square for ⌂ / point numbers. */
