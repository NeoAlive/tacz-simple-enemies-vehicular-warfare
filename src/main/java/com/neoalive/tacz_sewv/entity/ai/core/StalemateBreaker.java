 ...
 */
public final class StalemateBreaker {
    ...
    public StalemateBreaker(AbstractUnit unit) {
        this.unit = unit;
    }
     ...
     */
    @Nullable
    public BlockPos update(LivingEntity target, BlockPos combatPos, double ringRadius) {
